                        ...
                        <div class="notepad">
                            ...
                            <div class="action-buttons">
                                <div class="left chrome">
                                    <a href="https://dictation.io/speech#" class="btn-mic btn btn--primary-1">
...
<!--                                    <a data-tooltip="Publish your note online"-->
<!--                                       href="https://dictation.io/speech#"-->
<!--                                       onclick="dictation('gist');-->
<!--                                       return false;"-->
<!--                                       class="btn btn--sm btn-save btn--primary">-->
<!--                                        <span class="btn__text">Publish</span>-->
<!--                                    </a>-->
<!--                                    <a data-tooltip="Share on Twitter"-->
<!--                                       target="_blank"-->
<!--                                       href="https://twitter.com/intent/tweet?related=labnol&amp;-->
<!--                                       text=I%20%E2%9D%A4%20dictation.io%20for%20voice%20typing&amp;-->
<!--                                       via=labnol&amp;-->
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <ul class="list-inline">
                            <li>
                                <a href="https://dictation.io/"
                                   title="Type with your voice">
                                    <span class="h6 type--uppercase">Dictation</span>
                                </a>
                            </li>
<!--                            <li>-->
<!--                                <a href="https://dictation.io/help">-->
<!--                                    <span class="h6 type--uppercase">FAQ</span>-->
<!--                                </a>-->
<!--                            </li>-->
<!--                            <li>-->
<!--                                <a href="https://dictation.io/languages">-->
<!--                                    <span class="h6 type--uppercase">Languages</span>-->
<!--                                </a>-->
<!--                            </li>-->
<!--                            <li>-->
<!--                                <a href="https://dictation.io/commands"-->
<!--                                   title="Voice Commands for Speech Recognition">-->
<!--                                    <span class="h6 type--uppercase">Commands</span>-->
<!--                                </a>-->
<!--                            </li>-->
                            <li>
                                <a href="https://digitalinspiration.com/google-developer">
                                    <span class="h6 type--uppercase">Developer</span>
                                </a>
                            </li>
                            <li>
                                <a href="https://digitalinspiration.com/contact">
                                    <span class="h6 type--uppercase">Contact</span>
                                </a>
                            </li>
                        </ul>
                        <div class="clearfix">
                            <span class="">Made in India — ©
                                <span class="update-year"> 2018</span>
                                <span class="credit">
                                    <a href="https://digitalinspiration.com/">Digital Inspiration</a>
                                </span>
                            </span>
                        </div>
                    </div>
