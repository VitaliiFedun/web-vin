...
class m130524_201442_init extends \yii\db\Migration
{
    public function up()
    {
        ...
        $this->addForeignKey(
            'FK_comment_post', Comments::tableName(), 'entityId', Posts::tableName(), 'id'
        );
        $this->createIndex('FK_comment_createdBy', Comments::tableName(), 'createdBy');
        $this->addForeignKey(
            'FK_comment_createdBy', Comments::tableName(), 'createdBy', User::tableName(), 'id'
        );
